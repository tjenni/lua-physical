...
electric \newline resistance & % check
ohm & 
|_Ohm| & 
$\L[2] M \T[-3] \I[-2]$ & 
|_V/_A| \\

electric \newline conductance & % check
siemens & 
|_S| & 
$\L[-2] \M[-1] T^{3} I^{2}$ & 
|_A/_V| \\
...
|1e-6*_1|  \\
 ...
 &
parts-per-billion & % check
|_ppb| &
$\1$ &
|1e-9*_1|  \\

 &
parts-per-trillion & % check
|_ppt| &
$\1$ &
|1e-12*_1|  \\

 &
parts-per-quadrillion & % check
|_ppq| &
$\1$ &
|1e-15*_1|  \\

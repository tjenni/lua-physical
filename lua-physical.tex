...
|nominalsolareffectivetemperature| &
|_T_Sun| &
$\K[1]$ & 
|5772 * _K|  \\

|nominalsolarmassparameter| &
|_GM_Sun| &
$\L[3]\T[-2]$ & 
|1.3271244e20 * _m^3 * _s^-2|  \\

|nominalterrestrialequatorialradius| &
|_Re_E| &
$\L[1]$ & 
|6.3781e6 * _m|  \\

|nominalterrestrialpolarradius| &
|_Rp_E| &
$\L[1]$ & 
|6.3568e6 * _m|  \\

|nominalterrestrialmassparameter| &
|_GM_E| &
$\L[3]\T[-2]$ & 
|3.986004e14 * _m^3 * _s^-2|  \\


|nominaljovianequatorialradius| &
|_Re_J| &
$\L[1]$ & 
|7.1492e7 * _m|  \\

|nominaljovianpolarradius| &
|_Rp_J| &
$\L[1]$ & 
|6.6854e7 * _m|  \\

|nominaljovianmassparameter| &
|_GM_J| &
$\L[3]\T[-2]$ & 

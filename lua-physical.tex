...
This is a standalone package. If a pretty print to \LuaLaTeX{} is needed, the package |siunitx| should be installed. 
...
% define macros for printing dimensions
...
There are a few units with dimension $\1$.
...
\printunit[\ \protect\footnotemark]{_pt}{_in/72}
...
%------------------------------------------------------------
\newpage
\subsection{Variable International Currencies}
\label{ch:variable currencies}
...
function printcurrency(start,n)
...
function printcurrencyrow(v,def)
    q = _G["_"..v]
    ...
    if _G["_c"..v] ~= nil then
      ...
      tex.print("|_c"..v.."|&")
      tex.print("\\texttt{"..(p/q):to(_1):__tonumber().." * \\_"..v.."} \\\\")
    end
end
...
%------------------------------------------------------------
\newpage
\subsection{Pegged International Currencies}

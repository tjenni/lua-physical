...
\section{Basic usage}
This package is a pure Lua library. Therefore one has to require it explicitly by calling |require("physical")|. For printing calculation results the |siunitx| package can be used. It's recommended to define a macro like |\q| or |\Qty| to convert the lua quantity object to a |siunitx| expression.
...
\newpage
Given the basic preamble, units can be used in lua code. The Result of a calculation can be printed  by using the macro |\q{}|.

...
\method{Quantity}{min(o1, o2)}
\begin{quote}
  Compares two quantities and returns the smaller one. The function returns |o1| if the two Quantities are equal.

  \begin{description}
  \item |o1| : |Quantity,Number|, first argument

  \item |o2| : |Quantity,Number|, second argument
  \end{description}
...
s_1 = 15 * _m
s_2 = 5 * _m
print(Quantity.min(s_1,s_2))
print(s_1:min(s_2))
\end{lstlisting}
\end{quote}


\method{Quantity}{max(o1, o2)}
\begin{quote}
  Compares two quantities and returns the bigger one.  The function returns |o1| if the two Quantities are equal.
...
\method{Quantity}{abs(o)}
\begin{quote}
  Calculates and returns the absolute value of the given quantity.

  \begin{description}
  \item |o| : |Quantity,Number|
  \end{description}
...
\method{Quantity}{sqrt(o)}
\begin{quote}
  Calculates and returns the square root of the given quantity.
...
\method{Quantity}{log(o, base)}
\begin{quote}
  Calculates and returns the logarithm of the given quantitiy. If no base is given, the natural logarithm is calculated.
